...
switch($tham_so){
    ...
    case "sua_san_pham":
        ...
        break; 
    case "hoa_don":
        include 'chuc_nang/hoa_don/lien_ket_hoa_don.php';
        break;
    case "them_hoa_don":
        include 'chuc_nang/hoa_don/them_hoa_don.php';
        break;
    case "quan_ly_hoa_don":
        include 'chuc_nang/hoa_don/quan_ly_hoa_don.php';
        break;
    case "sua_hoa_don":
        include 'chuc_nang/hoa_don/sua_hoa_don.php';
        break; 
